...
if( cluster.isMaster )
{
	...
	for( let worker of workers )
	{
		...
		worker.ipc.send( 'message_topic_unhandled', 1 ).catch( e => data.get(worker).send_topic_unhandled = ( e === 'IPC_UNHANDLED_MESSAGE' ) );
...
else
{
	...
	ipc.send( 'message_topic_unhandled', 1 ).catch( e => data.send_topic_unhandled = ( e === 'IPC_UNHANDLED_MESSAGE' ) );
